                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left" novalidate runat="server">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <asp:TextBox Rows="1" type="tel" ID="telefono" name="telefono" required="required" class="form-control col-md-7 col-xs-12" value="****" placeholder="46943636" runat="server" />
                        ...
                        <br />
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="actividades">
                                Actividades<span class="required"></span>
                            </label>
                            <div class="btn-group" data-toggle="buttons">
                                <div>
                                    <asp:ListBox ID="actividades" name="actividades" CssClass="select--multiple" runat="server" SelectionMode="Multiple" multiple="multiple"></asp:ListBox>
                                </div>
                            </div>
                        </div>
