                    ...
                    <form class="form-horizontal form-label-left" novalidate runat="server">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="descripcion" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="descripcion" maxlength="50" placeholder="Zumba" runat="server" required="required" type="text" data-parsley-error-message="my message">

                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tarifa">
                                Tarifa <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="timein">
                                Horario Inicio <span class="required">*</span>
                            </label>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="timeout">
                                Horario Fin <span class="required">*</span>
                            </label>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dia">
                                Dia Semana <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
