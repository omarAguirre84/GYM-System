                    ...
                    <form class="form-horizontal form-label-left" novalidate runat="server">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input ID="nombre" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nombre" placeholder="Socrates" required="required" type="text" data-parsley-error-message="my message" runat="server">
                        </div>
                      </div>
